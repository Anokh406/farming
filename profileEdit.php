                ...
                <form method="post" action="Profile/updateProfile.php">
                    ...
                    <div class="row uniform">
                        ...
                        <div class="4u 12u$(xsmall)">
                            <input type="text" name="mobile" id="mobile" value="<?php echo $_SESSION['MobileNo'];?>"
                                placeholder="Mobile No" required />
                        </div>
                        <?php echo "<pre />";
                            print_r($_SESSION['MobileNo']);
                            die;
                                ?>
                        ...
                        <div class="6u 12u$(xsmall)">
                            <div class="select-wrapper">
                                <select name="section" id="section">
                                    <option value="<?php echo $_SESSION['Section'];?>">
                                        <?php echo $_SESSION['Section'];?></option>
                        ...
                        <div class="6u 12u$(xsmall)">
                            <input type="text" name="post" id="post" value="<?php echo $_SESSION['Post'];?>"
